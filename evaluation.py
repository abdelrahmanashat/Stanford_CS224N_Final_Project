...
# Evaluate multitask model on a pair of sentences only for paraphrases.
...
# Evaluate multitask model on a pair of sentences only for similarity.
def model_eval_similarity(dataloader, model, device):
    model.eval()  # Switch to eval model, will turn off randomness like dropout.
    y_true = []
    y_pred = []
    sent_ids = []
